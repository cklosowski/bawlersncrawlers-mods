...
class bnc_woocommerce_full_width_promo_widget extends WP_Widget {
	function __construct() {
		...
		parent::__construct( false, $name = esc_html__( 'BnC: Horizontal Promo WC Category', 'estore' ), $widget_ops, $control_ops);
	}
